...
<div class="users index container">
    ...
    <div class="row">
	<div class="col-md-12">	    
	    <?php echo $this->Html->link($this->Form->button("<span class='glyphicon glyphicon-plus'></span>  New User", array('class' => 'btn btn-primary')), array('controller' => 'users', 'action' => 'add'), array('escape' => false)) ?>	    
	</div>
	<br><br><br>
    </div>
