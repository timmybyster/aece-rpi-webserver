...
function zoomIn(){
	zoom = zoom + 0.01;
	mine_map.scale.x = $('#cnfBackgroundImgSizeMultiply').val()*1;
}
function zoomOut(){
	zoom = zoom - 0.01;
	mine_map.scale.x = $('#cnfBackgroundImgSizeMultiply').val()*30;
}
...
function createKeyboardInputs() {
    ...
    keyZ.onDown.add(zoomIn, this);
	var keyX = game.input.keyboard.addKey(Phaser.Keyboard.X);
    keyX.onDown.add(zoomOut, this);
}
...
function create_mine_map() {
    ...
    mine_map.scale.x = $('#cnfBackgroundImgSizeMultiply').val()*10;
    ;
    mine_map.scale.y = $('#cnfBackgroundImgSizeMultiply').val()*10;
    ;
