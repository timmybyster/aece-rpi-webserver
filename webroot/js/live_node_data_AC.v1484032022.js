...
function createNodeVisuals() {
	...
	nodeVisual.scale.set(0.37, 0.37);
	...
	// key switch status
	keySwitchStatusArmed = game.add.sprite(nodeVisual.width + 16, -nodeVisual.height - 10, 'keySwitchArmed', 0);
	keySwitchStatusDisarmed = game.add.sprite(nodeVisual.width + 16, -nodeVisual.height - 10, 'keySwitchDisarmed', 0);
